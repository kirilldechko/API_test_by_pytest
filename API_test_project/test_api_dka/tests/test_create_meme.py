import allure
from bodies_for_tests import test_body, body_meme
import pytest
...
@allure.title("Create meme")
@pytest.mark.parametrize("test_body", test_body)
def test_create_new_meme_without_requirement_fild(test_body, check_token, create_meme_endpoint):
